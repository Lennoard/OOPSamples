package sample07.br.edu.ifpi.poo.banco.visao;

import java.util.Scanner;

import sample07.br.edu.ifpi.poo.banco.cadastros.Banco;
import sample07.br.edu.ifpi.poo.banco.entidade.AplicacaoException;
import sample07.br.edu.ifpi.poo.banco.entidade.Conta;
import sample07.br.edu.ifpi.poo.banco.entidade.ContaImposto;
...
public class ExecutaBanco {
	...
	private static void transferir() {
		...
		System.out.println("Digite o n�mero da conta de credito:");
		numeroCredito = sc.next();

		String numeroDebito;
		System.out.println("Digite o n�mero da conta de d�bito:");
	...
	private static void inserir() {
		...
		System.out.println("Digite o tipo de conta: 1) Conta  2) Poupan�a  3) Conta Imposto");
		String tipo = sc.next();
